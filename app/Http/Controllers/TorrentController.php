...
class TorrentController extends Controller
{
    ...
    public function getByType(Request $request)
    {
        ...
        else if ($type === 'popular_foreignmovie') {
            $torrents['data'] = PopularTorrent::with('subcategory')
